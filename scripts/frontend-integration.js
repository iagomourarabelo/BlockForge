 ...
 * This file demonstrates how to integrate Blockforge with a web frontend
 */

// For React/Vue/Angular applications
export class BlockforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BlockforgeClient(provider, contractAddress);
